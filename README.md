...
Jadeight 生态（虚拟机 + 汇编层 + 编译器 + 启动器 + 游戏 + 教程）的**启动器**与**文档中心**。

- **文档入口**：👉 [docs/00-文档索引.md](docs/00-文档索引.md) —— 全部项目的文档汇总、
  阅读路径（零基础 / 开发者 / VM 深入 / 示例参考）。
...
| 文档 | 内容 |
|---|---|
| [00-文档索引.md](docs/00-文档索引.md) | **全生态文档地图 + 阅读路径（先看这个）** |
| [01-总体架构.md](docs/01-总体架构.md) | 各工程角色与数据流总览 |
| [05-JadeightPoject启动器.md](docs/05-JadeightPoject启动器.md) | 启动器使用、VM 自动寻找、快速上手 |
